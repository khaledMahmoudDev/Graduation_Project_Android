...
import kotlinx.android.synthetic.main.fragment_to_do_done.*
...
class ToDoDone : Fragment() {
    ...
    override fun onResume() {
        ...
        todoListDone.layoutManager = LinearLayoutManager(context)
        todoListDone.adapter = todoAdapter
